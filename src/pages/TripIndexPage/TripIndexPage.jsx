...
export default function TripIndexPage({ allTrips, setAllTrips, setUpdated, updated, user }) {
    ...
    return (
        <div className="mt-40  ">
            ...
            <div className="w-600">
                <h1 className="mb-5 font-bold text-5xl text-[#CFFCFF] ">Hello,{user.name}</h1>
                <Link to="/trips/new">
            ...
            {allTrips.length ?
                <div className="flex flex-row mt-4">
                    ...
                    {allTrips.map((trip, idx) => (
                        ...
                        <div
                            key={idx}
                            className="m-5 border-black border-[3px] rounded-md pt-2 pb-4 px-4 font-light my-3 w-[13rem] h-98 text-left text-sm bg-[#FFFDE0]"
                            id="hardshadow"
                        >
